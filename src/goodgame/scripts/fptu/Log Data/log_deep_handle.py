...
class segment:
    def __init__(self):
        ...
        f = gfile.FastGFile("/home/goodgame/catkin_ws/src/semi_final/scripts/fptu/Handle/Utils/Tensor_RT Models/Model_2109_144_rb.pb", 'rb')
        ...
        self.label_codes, self.label_names = zip(*[self.parse_code(l) for l in open("/home/goodgame/catkin_ws/src/semi_final/scripts/fptu/Model/PSPNET_4classes/label_colors_4classes_old.txt")])
...
if __name__ == '__main__':
    ...
    # out = cv2.VideoWriter('/media/goodgame/3332-32338/Log/output_0112.avi',fourcc, 30.0, (144,144))

    while not rospy.is_shutdown():
        
        start_time = time.time()
        if read.frame is not None:
            # cv2.imshow('fuck',read.frame)
            ...
            try:
                ...
                if(count_segment_data% 5 == 0):
                    cv2.imwrite('/media/goodgame/3332-323312/Log/0212/Segment/Mask/Data_seg_mask_0212_'+str(count_segment_data)+'.png',frame_segment)
                    cv2.imwrite('/media/goodgame/3332-323312/Log/0212/Segment/Frame/Data_seg_frame_0212_'+str(count_segment_data)+'.png',read.frame)
