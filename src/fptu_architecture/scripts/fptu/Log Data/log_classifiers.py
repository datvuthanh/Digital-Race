...
def localization(centroids):
    ...
    with session.as_default():
        with session.graph.as_default():
            ...
            #cv2.imwrite('/media/goodgame/3332-32338/Log/Data_CNN/Data_CNN_1607_'+str(count_cnn)+'.png', image_cnn)
            #count_cnn += 1
...
if __name__ == '__main__':
    ...
    ## The first time we need call model to predict because numba need to complie the first time.
        ...
        # image_fake = cv2.imread('/home/goodgame/catkin_ws/src/fptu_architecture/scripts/fptu/Handle/Fake_images/goodgame_data_sign207.png')
        # image_fake = cv2.resize(image_fake,(144,144))
    img_dir = '/home/goodgame/catkin_ws/src/fptu_architecture/scripts/fptu/Log Data/Fake_images'
